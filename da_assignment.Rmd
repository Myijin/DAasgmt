...
2) The values in columns where dates and times are stored are converted to date/time objects for calculation purpose.
...
```{r, echo=FALSE}
print(predict.glm(model, newdata=data.frame(cycle.time=3), type="response")-
